        ...
        <table id="datatable" class="table table-bordered" >
            ...
            @foreach( $slider as $data)
                <tr>
                    ...
                    <td><img src="{{asset('uploads/photos/'. $data->image)}}" width="80px" height="50px" alt="Image"></td>
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ action('SliderimageController@store') }}" method="post" enctype="multipart/form-data">
                    {{csrf_field()}}
...
<div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{ action('SliderimageController@store') }}" method="post" id="editForm">
                {{csrf_field()}}
                {{method_field('PUT')}}
                <div class="modal-body">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        table.on('click', '.edit', function () {
            ...
            $('#editForm ').attr('action','{{ url('/slider/') }}/' + data[0]);
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        table.on('click', '.delete', function () {
            ...
            var data = table.row($tr).data();
            console.log(data);
            $('#deleteForm ').attr('action', '{{ url('/slider/') }}/' + data[0]);
